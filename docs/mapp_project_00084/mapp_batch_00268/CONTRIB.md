...
```bash
sg commons-users -c './copy_files.sh -i /mnt/bigdata/mapp/public/QE_HF_unifr/converted -o /media/nvme8tb/msdata/mapp_project_00084/mapp_batch_00268 -p "20260624_CVOL_Darleen*.mzML"'
```
...
cp ./metadata/treated/mapp_batch_00268_metadata.tsv /media/nvme8tb/msdata/mapp_project_00084/mapp_batch_00268/
```
