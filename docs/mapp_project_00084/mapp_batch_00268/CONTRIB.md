...
```bash
cd ./docs/mapp_project_00084/mapp_batch_00268
find ./results/met_annot_enhancer/a904b81d4b8c44649be91a3290881266 -type l -exec rm {} +
```
...
gnps_job_id : a904b81d4b8c44649be91a3290881266
...
```bash
met-annot-unifier-cli align-horizontally --canopus-file ./results/sirius/canopus_structure_summary.tsv --gnps-file ./results/met_annot_enhancer/a904b81d4b8c44649be91a3290881266/nf_output/library/merged_results_with_gnps.tsv --gnps-mn-file ./results/met_annot_enhancer/a904b81d4b8c44649be91a3290881266/nf_output/networking/clustersummary_with_network.tsv --sirius-file ./results/sirius/structure_identifications.tsv --isdb-file ./results/met_annot_enhancer/mapp_batch_00268/mapp_batch_00268_spectral_match_results_repond_flat.tsv --output ./results/tmp/mapp_batch_00268_met_annot_unified_horizontal.tsv
```

#### Align vertically

```bash
met-annot-unifier-cli align-vertically  --gnps-file ./results/met_annot_enhancer/a904b81d4b8c44649be91a3290881266/nf_output/library/merged_results_with_gnps.tsv --isdb-file ./results/met_annot_enhancer/mapp_batch_00268/mapp_batch_00268_spectral_match_results_repond_flat.tsv --sirius-file ./results/sirius/structure_identifications.tsv  --output ./results/tmp/mapp_batch_00268_met_annot_unified_vertical.tsv
```