...
```bash
sg commons-users -c './copy_files.sh -i /mnt/bigdata/mapp/public/QE_HFX_unifr/converted -o /msdata/mapp_project_00084/mapp_batch_00261 -p "*20260513_CVOL_02_29*_neg.mzML"'
```

### Transfer the metadata to the msdata folder

```bash
cd ./docs/mapp_project_00084/mapp_batch_00261/
cp ./metadata/treated/mapp_batch_00261_metadata.tsv /msdata/mapp_project_00084/mapp_batch_00261/mapp_batch_00261_metadata.tsv
```
...
```bash
cd ./docs/mapp_project_00084/mapp_batch_00261/results/mzmine
```

And proceed to awk black magic to update the mzmine xml file

```bash
awk -v dir="/msdata/mapp_project_00084/mapp_batch_00261" '
BEGIN {
  cmd = "ls " dir "/*.mzML"
...
}' mapp_batch_00261.mzbatch_template > mapp_batch_00261.mzbatch
```
...
```bash
sg commons-users -c '/opt/mzmine/bin/mzmine -batch mapp_batch_00261.mzbatch'
```
...
```bash
taxonomical-utils resolve-taxa --input-file docs/mapp_project_00084/mapp_batch_00261/metadata/original/mapp_batch_00261_metadata.tsv --output-file docs/mapp_project_00084/mapp_batch_00261/metadata/original/mapp_batch_00261_metadata_resolved.csv --org-column-header source_taxon
```

2. retrieve upper taxa lineage
    
```bash
taxonomical-utils append-taxonomy --input-file docs/mapp_project_00084/mapp_batch_00261/metadata/original/mapp_batch_00261_metadata_resolved.csv --output-file docs/mapp_project_00084/mapp_batch_00261/metadata/original/metadata_upper_taxa_lineage.csv
```

3. append WD ids 

```bash
taxonomical-utils append-wd-id --input-file docs/mapp_project_00084/mapp_batch_00261/metadata/original/mapp_batch_00261_metadata_resolved.csv --output-file docs/mapp_project_00084/mapp_batch_00261/metadata/original/mapp_batch_00261_wd.csv
```

```bash
taxonomical-utils merge --input-file docs/mapp_project_00084/mapp_batch_00261/metadata/original/mapp_batch_00261_metadata.tsv --resolved-taxa-file docs/mapp_project_00084/mapp_batch_00261/metadata/original/mapp_batch_00261_metadata_resolved.csv --upper-taxa-lineage-file docs/mapp_project_00084/mapp_batch_00261/metadata/original/metadata_upper_taxa_lineage.csv --wd-file docs/mapp_project_00084/mapp_batch_00261/metadata/original/mapp_batch_00261_wd.csv --output-file docs/mapp_project_00084/mapp_batch_00261/metadata/treated/mapp_batch_00261_metadata.tsv --org-column-header source_taxon
```
...
ssh commons-server
tmux a -t sirius
cd ~/git_repos/mapp-metabolomics-unit/nathalie-jung-group/docs/mapp_project_00084/mapp_batch_00261/results
```
...
paths:
  gnps_job_id: 4f9e9c35b51e428caff8324fb153e558 # The GNPS job id you want to treat
  input_folder: /Users/voletco/git_repos/mapp-metabolomics-unit/nathalie-jung-group/docs/mapp_project_00084/mapp_batch_00261/results/met_annot_enhancer # The path were you want your GNPS job folder to be placed
  project_name: mapp_batch_00261 #ISDB_annot_LP_plantfungi_set # The name you want to give to your project, output resulst in data_out/project_name
  output_folder: /Users/voletco/git_repos/mapp-metabolomics-unit/nathalie-jung-group/docs/mapp_project_00084/mapp_batch_00261/results/met_annot_enhancer # the path for your output to be stored in
  ...
  db_file_path: /Users/pma/01_large_files/mgf/isdb_neg_cleaned.pkl  # Path to your spectral library file. You can use multiple ones. Just list them as [a.mgf, b.mgf, c.mgf]
...
repond_params:
  ...
  polarity: 'neg' # ion mode you are working with (pos or neg)
...
```bash
cd ./docs/mapp_project_00084/mapp_batch_00261
find ./results/met_annot_enhancer/4f9e9c35b51e428caff8324fb153e558 -type l -exec rm {} +
```
...
paths:
  ...
  output: '/Users/voletco/git_repos/mapp-metabolomics-unit/nathalie-jung-group/docs/mapp_project_00084/mapp_batch_00261/results/stats' # Not mandatory, default is in the stats subdirectory
...
mapp_batch : mapp_batch_00261
met_annot_enhancer_folder : mapp_batch_00261
gnps_job_id : 4f9e9c35b51e428caff8324fb153e558

dataset_experiment : 
  name: "mapp_batch_00261 LCMS metabolomics dataset"
...
```bash
met-annot-unifier-cli align-horizontally --canopus-file ./results/sirius/canopus_structure_summary.tsv --gnps-file ./results/met_annot_enhancer/4f9e9c35b51e428caff8324fb153e558/nf_output/library/merged_results_with_gnps.tsv --gnps-mn-file ./results/met_annot_enhancer/4f9e9c35b51e428caff8324fb153e558/nf_output/networking/clustersummary_with_network.tsv --sirius-file ./results/sirius/structure_identifications.tsv --isdb-file ./results/met_annot_enhancer/mapp_batch_00261/mapp_batch_00261_spectral_match_results_repond_flat.tsv --output ./results/tmp/mapp_batch_00261_met_annot_unified_horizontal.tsv
```

#### Align vertically

```bash
met-annot-unifier-cli align-vertically  --gnps-file ./results/met_annot_enhancer/4f9e9c35b51e428caff8324fb153e558/nf_output/library/merged_results_with_gnps.tsv --isdb-file ./results/met_annot_enhancer/mapp_batch_00261/mapp_batch_00261_spectral_match_results_repond_flat.tsv --sirius-file ./results/sirius/structure_identifications.tsv  --output ./results/tmp/mapp_batch_00261_met_annot_unified_vertical.tsv
```